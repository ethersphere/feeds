...
func TestEncodingDecodingUpdateRequests(t *testing.T) {
	...
	const expectedSignature = "7235b27a68372ddebcf78eba48543fa460864b0b0e99cb533fcd3664820e603312d29426dd00fb39628f5299480a69bf6e462838d78de49ce0704c754c9deb261c"
	const expectedJSON = `{"feed":{"topic":"6120676f6f6420746f706963206e616d65000000000000000000000000000000","user":"876a8936a7cd0b79ef0735ad0896c1afe278781c"},"epoch":{"time":1000,"level":1},"protocolVersion":0,"data":"5468697320686f75722773207570646174653a20537761726d2039392e3020686173206265656e2072656c656173656421"}`
...
func TestUpdateChunkSerializationErrorChecking(t *testing.T) {
	...
	compareByteSliceToExpectedHex(t, "chunk", data, "")

	var recovered Request
	err = recovered.fromChunk(addr, data)
	if err != nil {
		t.Fatal(err)
	}
